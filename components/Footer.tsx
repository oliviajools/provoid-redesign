        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/#home" className="text-sm text-text-primary hover:text-text-secondary transition-colors">Home</Link></li>
              <li><Link href="/#referenzen" className="text-sm text-text-primary hover:text-text-secondary transition-colors">Referenzen</Link></li>
              <li><Link href="/#angebot" className="text-sm text-text-primary hover:text-text-secondary transition-colors">Angebot</Link></li>
              <li><Link href="/#prozess" className="text-sm text-text-primary hover:text-text-secondary transition-colors">Prozess</Link></li>
              <li><Link href="/insights" className="text-sm text-text-primary hover:text-text-secondary transition-colors">Einblicke</Link></li>
            </ul>
          </div>
