      ...
      {mobileMenuOpen && (
        <nav className="md:hidden border-t border-border bg-surface">
          <div className="container py-4 flex flex-col gap-4">
            ...
            <Link href="/company" className="text-sm font-medium text-text-primary" onClick={() => setMobileMenuOpen(false)}>Company</Link>
            <Link href="/sports" className="text-sm font-medium text-text-primary" onClick={() => setMobileMenuOpen(false)}>Sports</Link>
            <Link href="/insights" className="text-sm font-medium text-text-primary" onClick={() => setMobileMenuOpen(false)}>Neuro-Insights</Link>
            <Link href="/about" className="text-sm font-medium text-text-primary" onClick={() => setMobileMenuOpen(false)}>About</Link>
            <Link href="/kontakt" className="text-sm font-medium text-primary-accent" onClick={() => setMobileMenuOpen(false)}>Kontakt</Link>
          </div>
        </nav>
      )}
    </header>
